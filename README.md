...
~ - означает, что вы находитесь в домашней папке home данного юзера  <br>
...
без полного указания пути к ним <br>
...
<a href="/01_info/help/HELP.md">Разная помощь по командам:</a> как правильно набрать команду,
какие команды существуют, описания, ключи и т.д.
